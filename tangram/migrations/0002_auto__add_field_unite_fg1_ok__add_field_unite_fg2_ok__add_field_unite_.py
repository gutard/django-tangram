...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unite.fg1_ok'
        db.add_column(u'tangram_unite', 'fg1_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg2_ok'
        db.add_column(u'tangram_unite', 'fg2_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg3_ok'
        db.add_column(u'tangram_unite', 'fg3_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg4_ok'
        db.add_column(u'tangram_unite', 'fg4_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg5_ok'
        db.add_column(u'tangram_unite', 'fg5_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg6_ok'
        db.add_column(u'tangram_unite', 'fg6_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unite.fg7_ok'
        db.add_column(u'tangram_unite', 'fg7_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unite.fg1_ok'
        db.delete_column(u'tangram_unite', 'fg1_ok')

        # Deleting field 'Unite.fg2_ok'
        db.delete_column(u'tangram_unite', 'fg2_ok')

        # Deleting field 'Unite.fg3_ok'
        db.delete_column(u'tangram_unite', 'fg3_ok')

        # Deleting field 'Unite.fg4_ok'
        db.delete_column(u'tangram_unite', 'fg4_ok')

        # Deleting field 'Unite.fg5_ok'
        db.delete_column(u'tangram_unite', 'fg5_ok')

        # Deleting field 'Unite.fg6_ok'
        db.delete_column(u'tangram_unite', 'fg6_ok')

        # Deleting field 'Unite.fg7_ok'
        db.delete_column(u'tangram_unite', 'fg7_ok')
